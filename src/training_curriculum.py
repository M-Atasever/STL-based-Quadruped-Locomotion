...
latest_ckpt = '/home/matasever/projects/Quadrupeds_STLReward/models8/ckpts/2026_04_19/222412800'  # WALK + TROT 

today = date.today().strftime('%Y_%m_%d')
path_ = f'/home/matasever/projects/Quadrupeds_STLReward/boundq5/ckpts/{today}'     # BOUND
...
"""env = BarkourEnv(command_sampling="mixed",
            bound_straight_commands=True,
            contact_z_on=0.003,
            contact_z_off=0.010)  """

env =  BarkourEnv(command_sampling="mixed", bound_straight_commands=True, obs_noise=0.001, kick_vel=0.001)  # BarkourEnv()
eval_env = BarkourEnv(command_sampling="mixed", bound_straight_commands=True, obs_noise=0.001, kick_vel=0.001)  # BarkourEnv()
...
today = date.today().strftime('%Y_%m_%d')
model_path = f'/home/matasever/projects/Quadrupeds_STLReward/boundq5/{today}'
